class TEXTS:
    ...
    SOURCE = (
        "**Source 📦:**\n\n"
        "**Thanks for using XYTRABOTS:** \n__» The source code is available on GitHub. You can find the link below.__\n"
        "__» Every project available under Xytra ZN are open-source and free to use and modify to your needs.__\n"
        ...
        "__» Feel free to contact @xytra_zn if you need any help regarding the source code.__\n\n"
        "❤️🎶 {0}"
    )
    STATS = (
        "**⤞ Server Stats:**\n"
